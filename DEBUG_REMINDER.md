...
4. **Vista Fija**: Se forzó la vista fija (zoom 4.6 y centro en Madrid) en pantallas < 1280px. Esto ignora cualquier configuración del backend que intente mover el mapa a otras ciudades (ej. León), asegurando que el Mini PC siempre muestre la península.
