...
class UI(BaseModel):
    ...
    map: MapConfigV1 = Field(default_factory=MapConfigV1)
...
class LayersConfigV1(BaseModel):
...
class AppConfig(BaseModel):
    ...
    layers: LayersConfigV1 = Field(default_factory=LayersConfigV1)
...
# ==========================================
# V2 MODELS (Migrated from models_v2.py)
# ==========================================
...
class WeatherLayersConfig(BaseModel):
    ...
    radar: Optional[WeatherLayerConfig] = Field(
        default_factory=lambda: WeatherLayerConfig(enabled=True, provider="maptiler_weather", opacity=0.7)
    )
