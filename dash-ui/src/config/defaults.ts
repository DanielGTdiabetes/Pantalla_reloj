...
// ==========================================
// V2 DEFAULTS (Migrated from defaults_v2.ts)
// ==========================================
...
export const DEFAULT_FLIGHTS_LAYER_CONFIG: FlightsLayerConfigV2 = {
  ...
  provider: "opensky",
  refresh_seconds: 12,
  max_age_seconds: 90, // FIXED: Changed from 120 to 90 (V1 value)
  max_items_global: 2000,
  max_items_view: 1500,
  rate_limit_per_min: 6,
  decimate: "none",
  grid_px: 24,
  styleScale: 1.4, // FIXED: Changed from 3.2 to 1.4 (V1 value)
  render_mode: "symbol_custom",
  circle: {
    radius_base: 7.5,
...
export const DEFAULT_CALENDAR_CONFIG: CalendarConfigV2 = {
  enabled: false,
  source: "google",
  provider: "google",
  days_ahead: 14,
